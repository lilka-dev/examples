...
/** Draw a line. */
void keira_display_draw_line(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
                             uint16_t color);

/** Draw a rectangle outline. */
void keira_display_draw_rect(int16_t x, int16_t y, int16_t w, int16_t h,
                             uint16_t color);

/** Fill a rectangle. */
void keira_display_fill_rect(int16_t x, int16_t y, int16_t w, int16_t h,
                             uint16_t color);
...
void keira_display_draw_triangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
                                 int16_t x2, int16_t y2, uint16_t color);

/** Fill a triangle. */
void keira_display_fill_triangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
                                 int16_t x2, int16_t y2, uint16_t color);
 ...
 *
 * Bits 0-9:   pressed  (UP=0, DOWN=1, LEFT=2, RIGHT=3, A=4, B=5, C=6, D=7,
 * SELECT=8, START=9) Bits 16-25: justPressed (same order shifted by 16)
 */
